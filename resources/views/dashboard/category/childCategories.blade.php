                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ route('category-child.delete') }}">
                                                        @csrf
                                                        <p>вы точно хотите удалить ету катекорию?</p>
                                                        <input type="hidden" value="{{ $item['categoryDetails']->id }}" name="id">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('category-child.add') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" id="preview-description" name="preview"></textarea>
                            </div>
                            <div class="form-group">
